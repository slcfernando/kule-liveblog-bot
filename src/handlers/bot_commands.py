...
LIVE_INSTRUCTIONS = """**Do not send anything here other than posts for editing.** Posts will automatically appear [here](https://docs.google.com/spreadsheets/d/1LV6mwlLq3BFBu0jmLNtJaNo1PA4S1brdS1-HKvOP-lA/edit?usp=sharing). All communications should be done via <COMMS URL>.
# Instructions:
